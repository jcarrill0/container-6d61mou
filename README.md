...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6d61mou.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6d61mou.containers.anotherwebservice.com/
...
```
git clone git@github.com:jcarrill0/container-6d61mou.git
cd container-6d61mou
```
...
```
docker attach container-6d61mou
```
